...
class TestPyramidalEpistemicGatesWithQ1Q2:
    ...
    def test_output_shapes(self):
        ...
        expected_keys = [
            'base_weights', 'w_memory', 'w_pain', 'w_choice', 'w_exploration',
            'base_stability', 'base_variance',
            'Q1_mean', 'Q1_var',
            'Q2_mean', 'Q2_var',
            'height', 'uncertainty',
            'fractal_uncertainty', 'total_uncertainty',
            'confidence'
        ]
...
class TestPyramidalVAROLossWithQ1Q2:
    ...
    def test_loss_computation(self):
        ...
        expected_keys = [
            'loss', 'ce_loss', 'base_loss', 'Q1_loss', 'Q2_loss',
            'fractal_loss', 'height_loss',
            'mean_Q1', 'mean_Q2', 'mean_height', 'mean_fractal'
        ]
        for key in expected_keys:
