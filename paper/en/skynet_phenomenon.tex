...
\begin{figure}[h]
\centering
% PLACEHOLDER: Insert Q1Q2 training curves after 60k run completes
% Expected to show: (a) ECE convergence to 0.060, (b) Height plateau at 0.971,
% (c) Q1/Q2 trajectories with small stable gap, (d) comparison with Pyramidal collapse
\includegraphics[width=\textwidth]{figures/q1q2_training_curves.png}
\caption{Q1Q2 pyramidal training dynamics over 5,000 steps. \textbf{[TO BE INSERTED]}}
\label{fig:q1q2_curves}
\end{figure}
